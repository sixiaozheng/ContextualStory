...
def save_videos_grid(videos: torch.Tensor, path=None, rescale=False, n_rows=6, fps=8, wandb=False, global_step=0, format="gif"):
    ...
    if format == "gif":
        ...
        return [Image.fromarray(image) for image in outputs]
